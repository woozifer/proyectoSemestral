 ...
 * @author sebas
 */
public class ControladorPeliculaModificar {
    PeliculaModificar vista;
    private Pelicula modelo;

    public ControladorPeliculaModificar(PeliculaModificar v, Pelicula m)
    {
        this.vista = v;
        this.modelo = m;
    }
    ...
    {  
        ...
        this.vista.cargarCategorias(categorias,this.modelo.getCategoriaByNombre(this.modelo.getId()));
        this.vista.setearPelicula(modelo.getPelicula(modelo));
